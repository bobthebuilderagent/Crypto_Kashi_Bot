...
// CEX Trading Settings - Strategy, risk management, order types for centralized exchanges
export function CEXTradingSettings() {
        ...
        <Card className="bg-slate-900/50 border-slate-700/50">
          <CardContent className="p-5 space-y-4">
            ...
            <div className="space-y-4">
              ...
              <div>
                <Label className="text-sm text-slate-400 mb-1 block">Fee Type</Label>
                <Select defaultValue="maker">
                  <SelectTrigger className="bg-slate-800 border-slate-700 text-white">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="maker">Maker (Lower fees)</SelectItem>
                    <SelectItem value="taker">Taker (Higher fees)</SelectItem>
                    <SelectItem value="auto">Auto-detect</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              <div>
                <Label className="text-sm text-slate-400 mb-1 block">Min Order Size (USD)</Label>
                <Input defaultValue="5" className="bg-slate-800 border-slate-700 text-white" />
              </div>
            </div>
          </CardContent>
